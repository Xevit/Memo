		...
		\begin{enumerate}
			...
			\item Si la aplicación no estaba dada de alta:
				\begin{enumerate}
					...
					\item Se llama al método \textit{DAORegisterApplication.registerApplication} (\href{https://github.com/Xevit/eclipse-workspace/blob/master/APIOAuth2/src/main/java/com/ptellos/dao/DAORegisterApplication.java}{\texttt{https://\linebreak github.com/Xevit/eclipse-workspace/blob/master/\linebreak APIOAuth2/src/main/java/com/ptellos/dao/\linebreak DAORegisterApplication.java}}) para almacenar todos los valores en la BBDD de la API.
	...
	\item Tanto la respuesta de que la clase ya estaba creada como la de que no estaba creada se manejarán desde el recurso \textbf{ApplicationOAuth2/AltaEnAPI} en el método que maneja las peticiones GET de la clase \textit{ApplicationRegistering.java} (\href{https://github.com/Xevit/eclipse-workspace/blob/master/ApplicationOAuth2/src/main/java/com/ptellos/application/ApplicationRegistering.java}{\texttt{https://github.com/\linebreak Xevit/eclipse-workspace/blob/master/ApplicationOAuth2/src/\linebreak main/java/com/ptellos/application/\linebreak ApplicationRegistering.java}}). 
		\begin{enumerate}
			...
			\item En caso de que la aplicación no estuviera dada de alta:
				\begin{enumerate}
					\item Se llamará al método \textit{DAORegisterApplication.registerApplication} (\href{https://github.com/Xevit/eclipse-workspace/blob/master/ApplicationOAuth2/src/main/java/com/ptellos/dao/DAORegisterApplication.java}{\texttt{https://\linebreak github.com/Xevit/eclipse-workspace/blob/master/\linebreak ApplicationOAuth2/src/main/java/com/ptellos/dao/\linebreak DAORegisterApplication.java}}) para almacenar todos los valores en la BBDD de la aplicación.
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\end{enumerate} 
		\item Mediante el método \textit{ListenerGrant.responsePost()} (\href{https://github.com/Xevit/eclipse-workspace/blob/master/APIOAuth2/src/main/java/com/ptellos/api/ListenerGrant.java}{\texttt{https://github.com/\linebreak Xevit/eclipse-workspace/blob/master/APIOAuth2/src/main/\linebreak java/com/ptellos/api/ListenerGrant.java}}) se creará un JSON que albergue toda la información para la finalización del proceso de concesión de autorización. Dicho JSON contendrá los siguientes datos:\\
	...
	\begin{enumerate}
		\item Se extraerá la información contendia en el JSON y mediante el método \textit{DAOValueApplicationRequest.setApplicationCredentials} (\href{https://github.com/Xevit/eclipse-workspace/blob/master/ApplicationOAuth2/src/main/java/com/ptellos/dao/DAOValueApplicationRequest.java}{\texttt{https://github.com/\linebreak Xevit/eclipse-workspace/blob/master/ApplicationOAuth2/src/\linebreak main/java/com/ptellos/dao/DAOValueApplicationRequest.java}}) se inicializarán dichos parámetros en la BBDD.
	\end{enumerate}
\end{enumerate}
