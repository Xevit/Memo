...
En este capítulo se describe detalladamente el proceso de diseño e implementación que se ha seguido para la realización del proyecto. 
...
\begin{itemize}
	\item Propietario del recurso: Usuario que autoriza a una aplicación para acceder a su cuenta. El acceso de la aplicación a la cuenta del usuario está limitado al "alcance" de la autorización otorgada (lectura/escritura).
...
El siguiente punto "Arquitectura general", pasa a describir los desarrollos mediante los flujos e interacciones entre los diferentes roles.
